Note from Andrey Prikupets:

This is modified version of original library. In the src\modules\espcore_wifi.h parts of code related to maintaining connection were removed, because this logic in my project is handled outside of the library.
