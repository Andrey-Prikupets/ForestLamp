...
class CRemoteXY : public CRemoteXY_API {
  ...
  public:
  CRemoteXY (const void * _conf, void * _var, const char * _accessPassword, uint16_t _port) {
    serverTimeOut = 0;
    port = _port;
...
#define RemoteXY_Init() remotexy = new CRemoteXY (RemoteXY_CONF_PROGMEM, &RemoteXY, REMOTEXY_ACCESS_PASSWORD, REMOTEXY_SERVER_PORT)
