...
/// AP; Don't use D4 in Wemos otherwise built-in blue LED will always shine!
#define LED_PIN               (D2)                          // пин ленты               
#define BUILT_IN_LED_PIN      (D4)
...
#define AP_NAME               ("ForestLamp")                // имя WiFi точки доступа, используется как при запросе SSID и пароля WiFi сети роутера, так и при работе в режиме ESP_MODE = 0
...
// RING 24LED;
//#define WIDTH                 (12U)                         // ширина матрицы
//#define HEIGHT                (2U)                         // высота матрицы
...
// TAPE 7x35 LEDs
//#define WIDTH                 (7U)                         // ширина матрицы
//#define HEIGHT                (35U)                         // высота матрицы

// Lamp 5x8 LEDs
#define WIDTH                 (8U)                         // ширина матрицы
#define HEIGHT                (5U)                         // высота матрицы
